...
curl -sS https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/newudpgw"
...
wget https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
