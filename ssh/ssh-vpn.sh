...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/ws-dropbear"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/ssh/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/arismaramar/AutoScriptXray-ssh/main/issue.net"
