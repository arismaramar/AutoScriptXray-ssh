...
wget -q -O /usr/bin/proxy3.js "https://github.com/arismaramar/AutoScriptXray-ssh/main/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://github.com/arismaramar/AutoScriptXray-ssh/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
...
read -n 1 -s -r -p "SCRIPT ANGGUN PREMIUM [ ENTER ]"
